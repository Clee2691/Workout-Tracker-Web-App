...
const WorkoutLog = () => {
  ...
  const [workoutSets, setWkSets] = useState([{_id: new Date().getTime(), set: 0, weight: 0, reps: 0 }]);
  ...
  const addButtonHandler = (index) => {
    setWkSets([...workoutSets, {_id: new Date().getTime(), set: index + 1, weight: 0, reps: 0 }]);
  };
      ...
      <div className="container">
        ...
        <div className="col-md-8 ms-auto me-auto">
          ...
          <div className="d-grid">
            <button className="btn btn-success" onClick={saveWorkoutBtnHandler}>
              Add workout
            </button>
          </div>
        </div>
