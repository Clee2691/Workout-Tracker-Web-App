    ...
    return (
        <nav className='navbar navbar-expand-md navbar-dark bg-primary'>
            <div className='container-fluid ms-2 me-2'>
                    ...
                    }
                    {
                        loggedIn &&                             
                            <div className='d-flex'>
                                ...
                                <img className='img-fluid rounded-circle' src='../images/avatars/maleprof2.jpg' width='48px'></img>
                            </div>
                    }
                ...
                <button className="navbar-toggler mt-2" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav">
